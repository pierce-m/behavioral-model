...
typedef i32 BmMcSessionHandle
typedef byte BmMcDevId
...
service SimplePreLAG {
  ...
  BmMcL1Handle bm_mc_node_create(
    ...
    2:BmMcDevId dev,
    3:BmMcRid rid,
    4:BmMcPortMap port_map,
    5:BmMcLagMap lag_map
  ) throws (1:InvalidMcOperation ouch),
